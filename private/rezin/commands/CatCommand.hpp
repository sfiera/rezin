...
#ifndef REZIN_COMMANDS_CAT_COMMAND_HPP_
#define REZIN_COMMANDS_CAT_COMMAND_HPP_
...
class CatCommand : public Command {
  public:
    CatCommand(const std::vector<sfz::StringPiece>& args);
...
#endif  // REZIN_COMMANDS_CAT_COMMAND_HPP_
